...
#[derive(Copy, Clone, Debug, PartialEq)]
pub struct Mat2x2(pub [f64; 4]);

impl Mat2x2 {
    /// Constructs a 2×2 matrix. Arguments are given in row-major order.
    pub fn new(a: f64, b: f64, c: f64, d: f64) -> Mat2x2 {
        Mat2x2([a, b, c, d])
    }
    ...
    pub fn scale(scale: f64) -> Mat2x2 {
        Mat2x2([scale, 0.0, 0.0, scale])
    }

    /// Constructs a rotation matrix.
    pub fn rotate(angle: f64) -> Mat2x2 {
...
impl ops::Mul<f64> for Mat2x2 {
    type Output = Mat2x2;
    #[inline]
    fn mul(self, rhs: f64) -> Mat2x2 {
        rhs * self
    }
}
